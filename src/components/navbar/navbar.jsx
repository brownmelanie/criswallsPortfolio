...
let [open, setOpen] =useState(false);
    ...
    return (
        <div className='absolute border-solid border border-x-transparent border-t-transparent border-b-neutral-700 w-full top-0 left-0'>
            <div className='items-center justify-between bg-transparent md:px-7 px-7 h-13 py-6'>
    {/*LOGO HERE*/}
                <div className='font-bold text-2xl cursor-pointer flex items-center gap-1'>
                    <h2 className='text-neutral-700 font-OffWhite'>CRISWALLS</h2>
                </div>
    {/*ICON HERE*/}
